...
namespace REVERSI_GAME
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                Camera.Position.X = MathHelper.Clamp(Camera.Position.X - 2, 0, (myMap.MapWidth - squaresAcross) * Tile.Tilelargeur);
            }
            ...
            {
                Camera.Position.Y = MathHelper.Clamp(Camera.Position.Y - 2, 0, (myMap.MapHeight - squaresDown) * Tile.Tilehauteur);
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            /*
             La variable Camera.Position maintient le point sur la carte qui doit être affiché dans le coin supérieur 
               ...
               Nous voulons simplement attirer notre première tuile à (0,0). Mais comme si notre caméra se déplace par incréments de moins d'un carrelage, 
               ...
               dont nous avons besoin pour afficher sur l'écran. Dans l'appel SpriteBatch.Draw() , le premier paramètre 
               ...
               Les valeurs offsetX et offsetY déplace le dessin de la tuile par la quantité calculée ci-dessus, 
            ...
            #endregion
            Vector2 firstSquare = new Vector2(Camera.Position.X / Tile.Tilelargeur, Camera.Position.Y / Tile.Tilehauteur);
            int firstX = (int)firstSquare.X;
            int firstY = (int)firstSquare.Y;

            Vector2 squareOffset = new Vector2(Camera.Position.X % Tile.Tilelargeur, Camera.Position.Y % Tile.Tilehauteur);
